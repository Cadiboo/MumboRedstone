...
public class BlockColoredWire extends Block
{
    public static final PropertyEnum<BlockColoredWire.EnumAttachPosition> NORTH = PropertyEnum.<BlockColoredWire.EnumAttachPosition>create("north", BlockColoredWire.EnumAttachPosition.class);
    public static final PropertyEnum<BlockColoredWire.EnumAttachPosition> EAST = PropertyEnum.<BlockColoredWire.EnumAttachPosition>create("east", BlockColoredWire.EnumAttachPosition.class);
    public static final PropertyEnum<BlockColoredWire.EnumAttachPosition> SOUTH = PropertyEnum.<BlockColoredWire.EnumAttachPosition>create("south", BlockColoredWire.EnumAttachPosition.class);
    public static final PropertyEnum<BlockColoredWire.EnumAttachPosition> WEST = PropertyEnum.<BlockColoredWire.EnumAttachPosition>create("west", BlockColoredWire.EnumAttachPosition.class);
	...
	public BlockColoredWire(int r,int g,int b,int r2,int g2,int b2)
    {
        super(Material.CIRCUITS);
        this.drop=Items.REDSTONE;
        ColR2=r2/255.0F;
        ColG2=g2/255.0F;
        ColB2=b2/255.0F;
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, BlockColoredWire.EnumAttachPosition.NONE).withProperty(EAST, BlockColoredWire.EnumAttachPosition.NONE).withProperty(SOUTH, BlockColoredWire.EnumAttachPosition.NONE).withProperty(WEST, BlockColoredWire.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
    }
    ...
    {
        int i = 0;
        boolean flag = state.getValue(NORTH) != BlockColoredWire.EnumAttachPosition.NONE;
        boolean flag1 = state.getValue(EAST) != BlockColoredWire.EnumAttachPosition.NONE;
        boolean flag2 = state.getValue(SOUTH) != BlockColoredWire.EnumAttachPosition.NONE;
        boolean flag3 = state.getValue(WEST) != BlockColoredWire.EnumAttachPosition.NONE;
    ...
    private BlockColoredWire.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
    {
        ...
        if (!canConnectTo(worldIn.getBlockState(blockpos), direction, worldIn, blockpos) && (iblockstate.isNormalCube() || !canConnectUpwardsTo(worldIn, blockpos.down())))
        {
            ...
            if (!iblockstate1.isNormalCube())
            {
                ...
                if (flag && canConnectUpwardsTo(worldIn, blockpos.up()))
                {
                    ...
                    {
                        return BlockColoredWire.EnumAttachPosition.UP;
                    }

                    return BlockColoredWire.EnumAttachPosition.SIDE;
                }
            }

            return BlockColoredWire.EnumAttachPosition.NONE;
        }
        else
        {
            return BlockColoredWire.EnumAttachPosition.SIDE;
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            Block block = blockAccess.getBlockState(pos.offset(side.getOpposite())).getBlock();
            
            if(block instanceof BlockRedstoneDiode)return i;
            if(block instanceof BlockNonDirCircuit)return i;
            
            if(block==Blocks.REDSTONE_WIRE)i--;
            if(block instanceof BlockColoredWire && block!=this)i--;
    ...
    protected boolean canConnectTo(IBlockState blockState, @Nullable EnumFacing side, IBlockAccess world, BlockPos pos)
    {
        ...
        if (block instanceof BlockColoredWire && block != this)
        {
            return false;
        }
    ...
    public boolean canConnectRedstone(IBlockState state, IBlockAccess world, BlockPos pos, @Nullable EnumFacing side)
    {
    	...
    	//if(world.getBlockState(pos.offset(side.getOpposite())).getBlock()==Blocks.REDSTONE_WIRE)
    		return false;
    	//else
    		//return true;
    }
    ...
    public int colorMultiplier(int p_176337_0_)
    {
