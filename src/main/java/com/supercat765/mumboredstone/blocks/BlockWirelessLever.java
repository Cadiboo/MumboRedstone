...
public class BlockWirelessLever extends BlockWirelessOutput{
    ...
    {
        super();
        this.setDefaultState(this.blockState.getBaseState().withProperty(CHANNEL, 0).withProperty(FACING, BlockLever.EnumOrientation.NORTH).withProperty(POWERED, Boolean.valueOf(false)));
    ...
    {
        return BlockWirelessButton.canPlaceBlock(worldIn, p_181090_1_, p_181090_2_);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.setBlockState(pos, this.getActualState(state,worldIn,pos), 3);
    ...
    {
        return new BlockStateContainer(this, new IProperty[] {FACING, POWERED,CHANNEL});
    }
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
    	...
    	if(TE!=null && TE instanceof TEWirelessSender)
    		return state.withProperty(CHANNEL, (int)((TEWirelessSender)TE).getChannel());
    	else
    ...
    public static enum EnumOrientation implements IStringSerializable
    {
        ...
        private static final BlockWirelessLever.EnumOrientation[] META_LOOKUP = new BlockWirelessLever.EnumOrientation[values().length];
        ...
        public static BlockWirelessLever.EnumOrientation byMetadata(int meta)
        {
        ...
        public static BlockWirelessLever.EnumOrientation forFacings(EnumFacing clickedSide, EnumFacing entityFacing)
        {
            switch (clickedSide)
            {
                case DOWN:
        ...
        static
        {
            for (BlockWirelessLever.EnumOrientation blocklever$enumorientation : values())
            {
