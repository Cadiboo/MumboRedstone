...
public class BlockPowerPistonStructureHelper {
    ...
    public BlockPowerPistonStructureHelper(World worldIn, BlockPos posIn, EnumFacing pistonFacing, boolean extending, int pushPower)
    {
        this.world = worldIn;
    ...
    public boolean canMove()
    {
        ...
        if (!BlockPowerPistonBase.canPush(iblockstate, this.world, this.blockToMove, this.moveDirection, false, this.moveDirection))
        {
    ...
    private boolean addBlockLine(BlockPos origin, EnumFacing p_177251_2_)
    {
        ...
        else if (!BlockPowerPistonBase.canPush(iblockstate, this.world, origin, this.moveDirection, false, p_177251_2_))
        {
            return true;
        }
        ...
        else
        {
            ...
            if (i + this.toMove.size() > pushPower)
            {
                return false;
            }
            else
            {
                while (block.isStickyBlock(iblockstate))
                {
                    ...
                    if (iblockstate.getBlock().isAir(iblockstate, this.world, blockpos) || !BlockPowerPistonBase.canPush(iblockstate, this.world, blockpos, this.moveDirection, false, this.moveDirection.getOpposite()) || blockpos.equals(this.pistonPos))
                    {
                        break;
                    }
                ...
                while (true)
                {
                    ...
                    if (!BlockPowerPistonBase.canPush(iblockstate, this.world, blockpos1, this.moveDirection, true, this.moveDirection) || blockpos1.equals(this.pistonPos))
                    {
                        return false;
                    }
