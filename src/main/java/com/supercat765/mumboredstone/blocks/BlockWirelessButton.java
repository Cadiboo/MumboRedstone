...
public class BlockWirelessButton  extends BlockWirelessOutput{
    ...
    public BlockWirelessButton()
    {
        super();
        this.setDefaultState(this.blockState.getBaseState().withProperty(CHANNEL, 0).withProperty(FACING, EnumFacing.NORTH).withProperty(POWERED, Boolean.valueOf(false)));
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.setBlockState(pos, this.getActualState(state.withProperty(POWERED, Boolean.valueOf(true)),worldIn,pos), 3);
            worldIn.markBlockRangeForRenderUpdate(pos, pos);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
    	...
    	if(TE!=null && TE instanceof TEWirelessSender){
    		//System.out.println(((TEWirelessSender)TE).getChannel());
    		return state.withProperty(CHANNEL, ((TEWirelessSender)TE).getChannel());
    	}
    	else
    	{
